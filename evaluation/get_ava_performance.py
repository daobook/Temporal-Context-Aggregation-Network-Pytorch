...
def parse_arguments():
  ...
  parser.add_argument(
      ...
      default="/mnt/data/FlylineData/flq/dataset/ava_anno/ground_truth/official_anno/ava_action_list_v2.2_for_activitynet_2019.pbtxt")
  ...
  parser.add_argument(
      ...
      type=argparse.FileType("r"),
      default="/mnt/data/FlylineData/flq/dataset/ava_anno/ground_truth/official_anno/ava_val_v2.2.csv")
      # required=True)
  parser.add_argument(
      "-d",
      "--detections",
  ...
  parser.add_argument(
      ...
      help=("Optional CSV file containing videoid,timestamp pairs to exclude "
            "from evaluation."),
      type=argparse.FileType("r"),
      default="/mnt/data/FlylineData/flq/dataset/ava_anno/ground_truth/official_anno/ava_val_excluded_timestamps_v2.2.csv")
      # required=False)
